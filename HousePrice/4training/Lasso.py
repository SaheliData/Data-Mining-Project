# -*- coding: utf-8 -*-
"""
Created on Sat Sep 17 19:10:45 2016
...
train=pd.read_csv("E:/IUB/House/data/train.csv")
test=pd.read_csv("E:/IUB/House/data/test.csv")

all_data=pd.concat((train.loc[:,'MSSubClass':'SaleCondition'],
                      test.loc[:,'MSSubClass':'SaleCondition']), ignore_index=True)

# Used to compute the missing value and best fit
...
BsmtFinType1_Condition = all_data.BsmtFinType1.replace({'GLQ': 1,
                                                          'ALQ': 1,
                                                          'BLQ': 0,
                                                          'Rec': 1,
                                                          'LwQ': 0,
...
BsmtFinType1_Condition.name = 'BsmtFinType1_Condition'

BsmtFinType2_Condition = all_data.BsmtFinType2.replace({'GLQ': 1,
                                                          'ALQ': 1,
                                                          'BLQ': 0,
                                                          'Rec': 1,
                                                          'LwQ': 0,
...
BsmtFinType2_Condition.name = 'BsmtFinType2_Condition'
#will start from 10
svm = SVC(C=100)
# price categories
